...
class ReviewController extends AbstractController
{
    ...
    public function index(ReviewRepository $reviewRepository, FilterService $filterService, SearchFormService $searchFormService): Response
    {
    ...
    public function new(Request $request, ReviewRepository $reviewRepository, FilterService $filterService, SearchFormService $searchFormService, ActivityRepository $activityRepository, CategoryRepository $categoryRepository): Response
    {
        $review = new Review();
